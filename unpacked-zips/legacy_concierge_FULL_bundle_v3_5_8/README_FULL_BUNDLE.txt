...
v3.5.8: Setup Helpers are now COLLAPSIBLE toggles with step-by-step instructions (nesting, DB view setup, icon hosting). They are minimized by default so they don’t overwhelm the page. Detection & tracking still work by matching the HELPER_TEXT marker in the toggle heading.
